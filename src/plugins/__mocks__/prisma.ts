...
process.env.DATABASE_URL = process.env.DATABASE_URL_WITHOUT_SCHEMA + '/' + schemaId;
process.env.DATABASE_URL_NON_POOLING = process.env.DATABASE_URL_WITHOUT_SCHEMA + '/' + schemaId;
...
afterAll(async () => {
	...
	process.env.DATABASE_URL = process.env.DATABASE_URL_WITHOUT_SCHEMA + '/' + currentDatabaseName;
